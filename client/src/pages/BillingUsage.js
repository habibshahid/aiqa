...
const BillingUsage = () => {
  ...
  const exportToCsv = () => {
    ...
    // Header
    csvContent += "Date,Evaluations,Tokens,Duration (sec),Price\n";
    
    // Add daily data
    billingData.dailyUsage.forEach(day => {
      csvContent += `${day.date},${day.evaluationCount},${day.totalTokens},${day.totalDuration},${day.totalPrice.toFixed(4)}\n`;
    });
                ...
                <div className="card-body">
                  <table className="table">
                    ...
                    <tbody>
                      ...
                      {billingData.priceBreakdown.aiContextGenerator > 0 && (
                        <tr>
                          <td>
