...
import { Sparkles, XCircle, Check, DollarSign } from 'lucide-react';
              ...
              <div className="modal-body">
                ...
                {usageCost && (
                  <div className="alert alert-info d-flex align-items-center mt-3">
                    ...
                    <div>
                      <strong>Usage Cost:</strong> {formatCurrency(usageCost.cost)} (internal) / {formatCurrency(usageCost.price)} (billable)
                    </div>
                  </div>
                )}
